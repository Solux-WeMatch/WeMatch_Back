...
public class ResponseMessage {
    ...
    public static final String SUCCESS_TODO_SAVE="Todo 생성 성공";
    public static final String SUCCESS_TODO_UPDATE="Todo 수정 성공";
    public static final String SUCCESS_TODO_CHECK="Todo 완료 변경 성공";
